...
if [ "$UEFI_MODE" -eq 1 ]; then
    ...
    function efistub() {
        ...
        artix-chroot /mnt efibootmgr | grep -q "0000" && artix-chroot /mnt efibootmgr -b 0000 -B
        artix-chroot /mnt cp /boot/vmlinuz-linux-zen /boot/efi/vmlinuz-linux-zen.EFI
        artix-chroot /mnt install -Dm644 /boot/vmlinuz-linux-zen /boot/efi/vmlinuz-linux-zen.efi
        artix-chroot /mnt install -Dm644 /boot/initramfs-linux-zen.img /boot/efi/initramfs-linux-zen.img
